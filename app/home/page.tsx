        ...
        >
          ...
          <div className="relative z-10 px-4 py-12 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center text-white">
              ...
              <div className="bg-white/95 backdrop-blur p-6 rounded-2xl shadow-md">
                <form className="flex flex-col sm:flex-row gap-4">
                  <input
                    type="text"
                    placeholder="Enter Skills or Job Title"
                    className="text-gray-800 flex-1 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />

                  <select className="text-gray-900 w-full sm:w-[200px] px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                  ...
                  <button
                    type="submit"
                    className="w-full sm:w-auto bg-blue-900 text-white px-6 py-2 rounded-lg hover:bg-blue-800 transition"
                  >
                    Search Jobs
                  </button>
                </form>
              ...
              {[
                ...
                >
                  ...
                  <CardContent className="relative z-10 h-full flex flex-col justify-center items-center text-white">
                    ...
                    <Button className="bg-orange-600 hover:bg-amber-800">
                      Explore Jobs
                    </Button>
                  </CardContent>
                </Card>
              ...
              {[
                ...
                <Card key={index}>
                  ...
                  <CardContent>
                    ...
                    <Progress
                      value={(job.applied / job.vacancy) * 100}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col justify-center space-y-4">
            <p className="text-lg text-gray-700 italic">
              &quot;The platform&apos;s commitment to user success is evident.
              The email alerts for application status updates keep you in the
              loop, and the intuitive design makes the entire job search process
        ...
        <div className="bg-white py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-black">
            <h2 className="text-3xl mb-4">
              {" "}
              <span className="font-bold">Subscribe </span>Newsletter
            </h2>
